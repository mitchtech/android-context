 ...
 * convenient functions in {@link edu.fsu.cs.contextprovider.data.Amarino} to
...
public interface ContextIntent {
	 ...
	 * <p>
	 * Input:
	 * <em>{@link edu.fsu.cs.contextprovider.ContextIntent.AmarinoIntent#EXTRA_DEVICE_ADDRESS}</em>
	 ...
	 * 
	 * <p>
	 * You have to pass in the type of extra you going to send; for example:
	 * BOOLEAN_EXTRA, BYTE_EXTRA, STRING_EXTRA, INTEGER_EXTRA, etc.
	 * </p>
	 */
	 ...
	 * e.g. edu.fsu.cs.contextprovider.plugins.compass.BackgroundService
	 */
	 ...
	 * 
	 * <i>Upper and lower bounds need to be specified when this visualizer is
	 * used.</i>
	 */
