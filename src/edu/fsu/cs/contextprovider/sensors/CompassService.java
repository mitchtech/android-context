...
public class CompassService extends AbstractContextService implements SensorEventListener, OnSharedPreferenceChangeListener {

	private static final String TAG = "Compass Service";
...
//			frequency = ContextConstants.COMPASS_POLL_FREQUENCY;
//			ignoreThreshold = ContextConstants.COMPASS_IGNORE_THRESHOLD;
			// pluginId = prefs.getInt(CompassEditActivity.KEY_PLUGIN_ID, -1);
...
//				// TODO some phones require dim wake lock to keep sensor alive
//				// during sleep
//				wl.acquire();
			} else {
...
//		if (CompassEditActivity.PREF_FREQUENCY.equals(key)) {
//			ignoreThreshold = CompassEditActivity.getRate(prefs.getInt(key, 50));
//		}
	}
